...
// @Router			/api/v1/patients/{patient-id}/relatives-id [get]
// @Security		ApiKeyAuth
func (s *patientHttpService) handleGetRelatviesId() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		dto, err := s.query.FindRelatviesIdByPatientId.Handle(ctx.Request.Context(), &patientUUID)
		if err != nil {
